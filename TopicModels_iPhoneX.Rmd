...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 1 seems to be about the improved camera",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 4 seems to be about the new facial recognition feature of the iPhone X",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 5 seems to be about the lost feature of the home button on the iPhone X",
    x = "word",
    y = "beta"
  ) +
  theme(
