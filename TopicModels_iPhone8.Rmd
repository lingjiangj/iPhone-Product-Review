...
commonWords <- c("iphone", "phone", "apple", "iPhone","6","8","7")
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 2 seems to be about Battery Life",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 5 seems to be about the Home Button Retention of the iPhone 8",
    x = "word",
    y = "beta"
  ) +
  theme(
...
theTopicsTop %>%
  ...
  labs(
    title = paste0("Top Words in Topic ", theTopic, " Word Distribution"), caption = "Topic 9 seems to be about the Wireless Charging capabilities of the iPhone 8",
    x = "word",
    y = "beta"
  ) +
  theme(
